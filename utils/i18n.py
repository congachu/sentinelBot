...
TEXTS = {
    "ko": {
        ...
        "audit_header": "기본 정보",
        "audit_log_channel": "로그 채널",
        "audit_language": "언어",
        "audit_section_risk": "Risk 정책",
        "audit_min_account_age": "계정 최소 나이",
        "audit_raid_detection": "레이드 탐지 (인원/초)",
        "audit_section_spam": "Spam 정책",
        "audit_rate_limit": "메시지 속도 제한",
        "audit_mentions_limit": "메시지당 최대 멘션",
        "audit_block_everyone": "@everyone/@here 차단",
        "audit_link_filter": "링크 필터",
        "audit_whitelist": "화이트리스트",
        "audit_section_lockdown": "Lockdown",
        "audit_lockdown_enabled": "활성화",
        "audit_lockdown_min_account": "계정 최소 나이",
        "audit_lockdown_min_guild": "서버 합류 최소 시간",
        "audit_section_panic": "Panic",
        "audit_panic_status": "상태",
        "audit_section_backups": "백업",
